...
Rscript scripts/plot_neutral_probability_neglog10p.R --heatmap_distance=chrom_weighted     --heatmap_cluster_mode=auto --heatmap_cluster_score=calinski_harabasz
